$(document).on("pagecreate", function() {
	...
	if(track.currentPeriod !== null) {
		...
		$("#zone-submit").html("<input type=\"submit\" class=\"ui-icon-check ui-btn-icon-left\" value=\"Cập nhật\" >");
	}
	else {
		$("#zone-submit").html("<input type=\"submit\" class=\"ui-icon-check ui-btn-icon-left\" value=\"Thêm\" >");
	}
