...
@section('navigator')
	<div data-role="navbar">
		<ul>
			<li>
				<a href="/method/1" data-icon="custom-refresh" data-iconpos="top" class="ui-nodisc-icon">
					Chu kỳ đều
				</a>
			</li>
			<li>
				<a href="/method/2" data-icon="custom-shuffle" data-iconpos="top" class="ui-nodisc-icon ui-btn-active ui-state-persist">
					Chu kỳ không đều
				</a>
			</li>
		</ul>
