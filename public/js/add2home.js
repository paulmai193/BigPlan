...
ath.intl = {
	...
	en_us: {
		ios: 'To add Big Plan web app to the home screen: tap %icon and then <strong>Add to Home Screen</strong>.',
		android: 'To add Big Plan web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by tapping the top right menu icon %icon.</small>'
	},
	...
	vi_VN: {
		ios: 'Để thêm ứng dụng web Big Plan vào màn hình chính: Nhấn vào biển tượng %icon và <strong>Add to Home Screen</strong>.',
		android: 'Để thêm ứng dụng web Big Plan vào màn hình chính, mở chức năng Tùy Chọn trên trình duyệt và nhấn vào <strong>Add to homescreen</strong>. <small>Mở Tùy Chọn này bằng cách nhấn vào biểu tượng %icon ở góc trên bên phải trình duyệt.</small>'
	},
